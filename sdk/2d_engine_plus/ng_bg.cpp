 ...
 */
extern __attribute__((weak)) const NGShowScreenFn ng_screen_table[1] = { 0 };
extern __attribute__((weak)) const uint16_t       ng_screen_count    = 0;
