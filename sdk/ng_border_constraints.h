...
void border_constraints_init(void);
void border_constraints_load(NGBorderConstraint *list, uint16_t count);
void border_constraints_update(void);
void border_constraints_reset_used(void);
