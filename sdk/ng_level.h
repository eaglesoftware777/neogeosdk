...
void level_set_camera(int16_t x, int16_t y, int16_t screen_w, int16_t screen_h);
void level_move_camera(int16_t dx, int16_t dy, int16_t screen_w, int16_t screen_h);
void level_camera_follow(int16_t target_x, int16_t target_y, int16_t screen_w, int16_t screen_h);
void level_camera_input(uint16_t joystick, int16_t speed, uint8_t axes, int16_t screen_w, int16_t screen_h);
void level_camera_joystick(int16_t speed, uint8_t axes, int16_t screen_w, int16_t screen_h);
