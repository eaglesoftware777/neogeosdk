...
/* ---------------------------------------------------------------- */
/*  Voice ALPHABET (ADPCM-A) — sound/samples/in_wav_a_voice/<x>.wav  */
/*                                                                   */
/*  26 alphabet samples (a.wav .. z.wav) encoded as ADPCM-A and      */
/*  bundled into the V-ROM right after the regular SFX bank.  The    */
/*  driver's ADPCMA_VOICE_BASE define (generated by sound/tools/     */
/*  vrom.py into sample_table.inc) is SOUND_SFX_COUNT in C terms.    */
/*                                                                   */
/*  Use playVoiceLetter(SOUND_VOICE_LETTER_A) for individual letters */
/*  or speakWord("HELLO") for full words.                            */
/* ---------------------------------------------------------------- */
#define SOUND_VOICE_LETTER_BASE  SOUND_SFX_COUNT
enum {
	SOUND_VOICE_LETTER_A = SOUND_VOICE_LETTER_BASE +  0,
	SOUND_VOICE_LETTER_B = SOUND_VOICE_LETTER_BASE +  1,
	SOUND_VOICE_LETTER_C = SOUND_VOICE_LETTER_BASE +  2,
	SOUND_VOICE_LETTER_D = SOUND_VOICE_LETTER_BASE +  3,
	SOUND_VOICE_LETTER_E = SOUND_VOICE_LETTER_BASE +  4,
	SOUND_VOICE_LETTER_F = SOUND_VOICE_LETTER_BASE +  5,
	SOUND_VOICE_LETTER_G = SOUND_VOICE_LETTER_BASE +  6,
	SOUND_VOICE_LETTER_H = SOUND_VOICE_LETTER_BASE +  7,
	SOUND_VOICE_LETTER_I = SOUND_VOICE_LETTER_BASE +  8,
	SOUND_VOICE_LETTER_J = SOUND_VOICE_LETTER_BASE +  9,
	SOUND_VOICE_LETTER_K = SOUND_VOICE_LETTER_BASE + 10,
	SOUND_VOICE_LETTER_L = SOUND_VOICE_LETTER_BASE + 11,
	SOUND_VOICE_LETTER_M = SOUND_VOICE_LETTER_BASE + 12,
	SOUND_VOICE_LETTER_N = SOUND_VOICE_LETTER_BASE + 13,
	SOUND_VOICE_LETTER_O = SOUND_VOICE_LETTER_BASE + 14,
	SOUND_VOICE_LETTER_P = SOUND_VOICE_LETTER_BASE + 15,
	SOUND_VOICE_LETTER_Q = SOUND_VOICE_LETTER_BASE + 16,
	SOUND_VOICE_LETTER_R = SOUND_VOICE_LETTER_BASE + 17,
	SOUND_VOICE_LETTER_S = SOUND_VOICE_LETTER_BASE + 18,
	SOUND_VOICE_LETTER_T = SOUND_VOICE_LETTER_BASE + 19,
	SOUND_VOICE_LETTER_U = SOUND_VOICE_LETTER_BASE + 20,
	SOUND_VOICE_LETTER_V = SOUND_VOICE_LETTER_BASE + 21,
	SOUND_VOICE_LETTER_W = SOUND_VOICE_LETTER_BASE + 22,
	SOUND_VOICE_LETTER_X = SOUND_VOICE_LETTER_BASE + 23,
	SOUND_VOICE_LETTER_Y = SOUND_VOICE_LETTER_BASE + 24,
	SOUND_VOICE_LETTER_Z = SOUND_VOICE_LETTER_BASE + 25
};
