...
/* ---------------------------------------------------------------- */
/*  Voice bank (ADPCM-A) — games/<game>/sound/samples/in_wav_a_voice */
/*                                                                   */
/*  sound/tools/vrom.py generates sdk/sound_voice_ids.h from every    */
/*  encoded file in out_a_voice. The constants are full ADPCM-A       */
/*  sample IDs and live immediately after SOUND_SFX_COUNT.            */
/* ---------------------------------------------------------------- */
