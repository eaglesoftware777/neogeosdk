...
# Existing configuration is preserved; use --force to restore defaults.
...
note = effects and transitions; preserve bright outlines
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create asset rules without overwriting game settings")
    parser.add_argument("--force", action="store_true", help="Replace existing rules with defaults")
