...
print("}")
print("")
print("const uint16_t * NEOGEO_USER ng_get_screen_palette(uint16_t screen_id) {")
print("    uint16_t i;")
print("    for (i = 0; i < ng_screen_palette_count; i++) {")
print("        if (ng_screen_palette_assets[i].asset_id == screen_id)")
print("            return ng_screen_palette_assets[i].colors;")
print("    }")
print("    return 0;")
print("}")
