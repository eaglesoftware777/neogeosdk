...
void NEOGEO_USER soundSetADPCMBVolume(uint8_t);
...
void NEOGEO_USER showWalkDemo(int loops, int delay_ms) {
  ...
  //  if (frame == 0) showScreen1(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 1) showScreen2(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 2) showScreen3(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 3) showScreen4(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 4) showScreen5(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 5) showScreen6(16, 520, 0xF, 0xAF, 9, 0xFFF);
    if (frame == 6) showScreen7(16, 520, 0xF, 0xAF, 9, 0xFFF);
    cyclexms(delay_ms);
    frame++;
    if (frame >= 7) frame = 0;
  }
...
//main demo game - automatic character screens
...
uint16_t  SCB4    = 0x0;
uint16_t  pal1[16];
setpal(pal1,0x0,0x0,0x213,0x1413,0x2613,0x7823,0x6d32,0x4d56,0x5e69,0x6f73,0x4975,0x6653,0x3346,0x5432,0x522,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal2[16];
setpal(pal2,0x0,0x7f7f,0x0,0x4407,0x7101,0xa00,0x5212,0x390c,0x424,0x7525,0x2b22,0x848,0x5d45,0x5a5a,0x5c6c,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal3[16];
setpal(pal3,0x0,0x7f7f,0x0,0x4407,0x7101,0x4900,0x5212,0x390c,0x5f0f,0x2525,0x2b22,0x5747,0x7d45,0xa5a,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal4[16];
setpal(pal4,0x0,0x7f7f,0x0,0x4407,0x7101,0x5212,0x2313,0x390c,0x7525,0x1b21,0x848,0x7949,0x7d45,0x5c6c,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal5[16];
setpal(pal5,0x0,0x7f7f,0x0,0x406,0x7101,0x609,0x1212,0x2313,0x390c,0x7525,0x1b21,0x2949,0x7d45,0x5c6c,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal6[16];
setpal(pal6,0x0,0x7f7f,0x0,0x4407,0x7101,0x5212,0x2313,0x390c,0x2414,0x6526,0x1b21,0x7949,0x7d45,0x5c6c,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal7[16];
setpal(pal7,0x0,0x7f7f,0x0,0x4407,0x7101,0x5212,0x2313,0x390c,0x2414,0x2626,0x1b21,0x7d45,0x694a,0x5c6c,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal8[16];
setpal(pal8,0x0,0x7f7f,0x0,0x2101,0x4407,0x7101,0x5212,0x390c,0x6525,0x1b21,0x7737,0x4d45,0x7949,0x5c6c,0x5e69,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal9[16];
setpal(pal9,0x0,0x7f7f,0x0,0x7101,0x5212,0x7313,0x5424,0x7525,0x5636,0x7737,0x5848,0x7949,0x7a5a,0x1c6b,0x2d6d,0x0);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal10[16];
setpal(pal10,0x0,0x6d32,0x213,0x1413,0x7823,0x4d56,0x5e69,0x6f73,0x4975,0x6653,0x3346,0x5432,0x522,0x0,0x0,0x0);
