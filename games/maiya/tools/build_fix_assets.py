...
GLYPHS = {
    ...
    0x02: (  # rose: one Secret Art charge -- a bud on a stem with a leaf
        "  ####  ",
        " # ## # ",
        " ## # # ",
        " # #### ",
    ...
    0x07: (  # solid block: the company eyecatcher is built out of these
        "########",
        "########",
        "########",
        "########",
    ...
    0x08: (  # half block, for the soft edge of a letter
        "  ####  ",
        " ###### ",
        "########",
        "########",
    ...
    0x0A: (  # forest friend: ears and a round face
        " #   #  ",
        " ##  ## ",
        " ##  ## ",
        " ###### ",
    ...
    0x0B: (  # might berry: three berries and a leaf
        "    ##  ",
        "   ##   ",
        " ##  ## ",
        "####### ",
    ...
    0x0F: (  # danger triangle: a pit, or anything else worth stopping for
        "   ##   ",
        "  ####  ",
        "  ####  ",
        " ###### ",
