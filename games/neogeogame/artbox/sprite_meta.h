...
#define NG_ASSET_STRIPS_9 3  /* 020_enemy.png */
...
static const NGSpriteAssetMeta g_ng_asset_meta[NG_ASSET_META_COUNT] = {
    ...
    { 768, 18, 4, 2, 6, 14, 10, 6, 43, 26, 1, 0, 16 }, /* 011_ship_alt.png */
    { 1024, 18, 4, 4, 6, 12, 0, 0, 64, 64, 1, 0, 16 }, /* i_are_spaceship.png */
    { 1280, 19, 2, 2, 7, 7, 13, 10, 5, 11, 1, 0, 16 }, /* 030_player_bullet.png */
    { 1536, 20, 2, 2, 7, 7, 13, 10, 5, 11, 1, 0, 16 }, /* 031_enemy_bullet.png */
    { 1792, 21, 4, 4, 6, 6, 13, 13, 37, 37, 1, 0, 16 }, /* 040_explosion.png */
    { 2048, 22, 3, 2, 0, 1, 0, 1, 48, 31, 1, 3, 3 }, /* 020_enemy.png */
    { 2304, 23, 2, 1, 7, 15, 5, 3, 22, 13, 1, 3, 16 }, /* 032_life.png */
};
