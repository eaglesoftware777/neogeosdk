...
uint16_t  SCB4    = 0x0;
uint16_t  pal1[16];
setpal(pal1,0x0,0x2209,0x9001,0x4004,0x448,0x941c,0x23a,0x4789,0xc003,0x5005,0xb207,0x931a,0xb116,0xb557,0x8001,0xfccb);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal2[16];
setpal(pal2,0x0,0xe34d,0x2105,0xc116,0xd789,0x8001,0xa104,0x2229,0x1002,0xf127,0x723a,0x9217,0x4348,0x3446,0x9000,0x2cbb);
...
/****************************************** screen 3 ******************************************/
uint16_t  pal3[16];
setpal(pal3,0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000);
...
/****************************************** screen 4 ******************************************/
uint16_t  pal4[16];
setpal(pal4,0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000);
...
/****************************************** screen 5 ******************************************/
uint16_t  pal5[16];
setpal(pal5,0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000);
...
/****************************************** screen 6 ******************************************/
uint16_t  pal6[16];
setpal(pal6,0x0,0x8de8,0x5bd6,0x2bc6,0x6de9,0xb792,0x682,0xd682,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773);
...
/****************************************** screen 7 ******************************************/
uint16_t  pal7[16];
setpal(pal7,0x0,0xfe50,0x1ffe,0xaf80,0xeb00,0xefc1,0x8d21,0xfe4,0x9fc0,0xffc,0x6d21,0x8f71,0x6c10,0x8c10,0xbe30,0xed21);
...
/****************************************** screen 8 ******************************************/
uint16_t  pal8[16];
setpal(pal8,0x0,0x9ff8,0xf51,0x921,0xcfc0,0x1ffe,0xb500,0xdb31,0x2fe1,0x9ffb,0x8d31,0xaf31,0x5610,0xdfa0,0x3f70,0x9ff5);
...
/****************************************** screen 9 ******************************************/
uint16_t  pal9[16];
setpal(pal9,0x0,0xe44e,0x5fd3,0x99ef,0xa879,0x9335,0x7459,0xe8bf,0xf78f,0xc67f,0x4126,0xae85,0x99af,0xb44a,0x7112,0x9eee);
...
/****************************************** screen 10 ******************************************/
uint16_t  pal10[16];
setpal(pal10,0x0,0xa779,0x7124,0xbccd,0x2335,0x4013,0x2557,0x679d,0x346,0x1123,0xb223,0x9ac,0x3569,0x9112,0x1457,0x8000);
load_palettes(pal10,PALETTES+PALOFFSET*25);
}

static const NGPaletteAsset ng_screen_palette_assets[] = {
    {1,16,{0x0,0x2209,0x9001,0x4004,0x448,0x941c,0x23a,0x4789,0xc003,0x5005,0xb207,0x931a,0xb116,0xb557,0x8001,0xfccb}},
    {2,17,{0x0,0xe34d,0x2105,0xc116,0xd789,0x8001,0xa104,0x2229,0x1002,0xf127,0x723a,0x9217,0x4348,0x3446,0x9000,0x2cbb}},
    {3,18,{0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000}},
    {4,19,{0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000}},
    {5,20,{0x0,0x6f10,0xe113,0x5579,0xa346,0x83b0,0xcfe0,0x4f80,0xb04e,0xdddc,0x48e0,0x9050,0xb7de,0x8080,0xa754,0x8000}},
    {6,21,{0x0,0x8de8,0x5bd6,0x2bc6,0x6de9,0xb792,0x682,0xd682,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773,0x1773}},
    {7,22,{0x0,0xfe50,0x1ffe,0xaf80,0xeb00,0xefc1,0x8d21,0xfe4,0x9fc0,0xffc,0x6d21,0x8f71,0x6c10,0x8c10,0xbe30,0xed21}},
    {8,23,{0x0,0x9ff8,0xf51,0x921,0xcfc0,0x1ffe,0xb500,0xdb31,0x2fe1,0x9ffb,0x8d31,0xaf31,0x5610,0xdfa0,0x3f70,0x9ff5}},
    {9,24,{0x0,0xe44e,0x5fd3,0x99ef,0xa879,0x9335,0x7459,0xe8bf,0xf78f,0xc67f,0x4126,0xae85,0x99af,0xb44a,0x7112,0x9eee}},
    {10,25,{0x0,0xa779,0x7124,0xbccd,0x2335,0x4013,0x2557,0x679d,0x346,0x1123,0xb223,0x9ac,0x3569,0x9112,0x1457,0x8000}},
};
...
const NGArtAsset ng_screen_art_assets[] = {
    ...
    {9,NG_ART_TYPE_SPRITE,24,2051,2303,3,2,2,3,0,16,48,31},
