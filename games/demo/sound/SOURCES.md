...
- `13.adpcma`: Laser shot (Index 12).
- `14.adpcma`: Explosion (Index 13).
- `15.adpcma`: Pick-up chime (Index 14).
- `16.adpcma`: Warning siren (Index 15).

Samples 13 to 16 are generated by `sound/tools/gen_arcade_sfx.py`; run it
with the `in_wav_a` directory as its argument to regenerate the WAVs before
`make samples`.
