...
#include "games/demo_plus/scenes/demo_plus_main.h"
...
/* Demo_plus has no separate attract — it goes straight to the main scene. */
...
//START_GAME handler — demo_plus runs the C++-engine-only showcase.
void NEOGEO_USER START_GAME(void) {
	clearFix();
	clearSprs();
	setBACKDROP(BLACK);
