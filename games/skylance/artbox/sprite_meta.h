...
static const NGSpriteAssetMeta g_ng_asset_meta[NG_ASSET_META_COUNT] = {
    ...
    { 768, 19, 2, 2, 0, 0, 5, 0, 22, 32, 1, 0, 2 }, /* sprite_p1_plane.png */
    { 1024, 20, 10, 15, 3, 1, 0, 0, 160, 240, 1, 0, 16 }, /* sprite_p2_pilot.png */
    ...
    { 3072, 28, 7, 7, 0, 0, 13, 0, 86, 112, 1, 3, 7 }, /* opponent_boss_heli_carrier.png */
    { 3328, 29, 5, 7, 1, 0, 13, 0, 54, 112, 1, 3, 7 }, /* opponent_boss_navy_battleship.png */
    { 3584, 30, 7, 7, 0, 0, 14, 0, 83, 112, 1, 3, 7 }, /* opponent_boss_red_fortress.png */
    { 3840, 31, 7, 7, 0, 0, 11, 0, 90, 112, 1, 3, 7 }, /* opponent_boss_stealth_bomber.png */
    { 4096, 32, 5, 7, 1, 0, 5, 0, 70, 112, 1, 3, 7 }, /* opponent_boss_tank_fortress.png */
    { 4352, 33, 2, 2, 0, 0, 0, 0, 32, 32, 1, 3, 2 }, /* opponent_drone_red.png */
    { 4608, 34, 2, 2, 0, 0, 2, 0, 28, 32, 1, 3, 2 }, /* opponent_fighter_grayred.png */
    { 4864, 35, 2, 2, 0, 0, 3, 0, 25, 32, 1, 3, 2 }, /* opponent_heli_gunship.png */
    { 5120, 36, 2, 2, 0, 0, 4, 0, 23, 32, 1, 3, 2 }, /* opponent_interceptor_blackgold.png */
    { 5376, 37, 2, 2, 0, 0, 9, 0, 14, 32, 1, 3, 2 }, /* opponent_missile_boat.png */
