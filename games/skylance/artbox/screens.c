...
uint16_t  SCB4    = 0x0;
uint16_t  pal1[16];
setpal(pal1,0x0,0x8654,0xf08d,0x6582,0x7b52,0x7ba7,0xa05b,0x7157,0x68b2,0x6032,0x74ac,0x6345,0x1362,0x2988,0x4122,0xbccc);
...
uint16_t  SCB4    = 0x0;
uint16_t  pal2[16];
setpal(pal2,0x0,0xb05c,0x24bf,0x8fff,0xe26b,0x8049,0xe7df,0x79bd,0x108e,0xcde,0xa04b,0xa19f,0x77ad,0xe2af,0x907d,0xd59c);
...
/****************************************** screen 3 ******************************************/
uint16_t  pal3[16];
setpal(pal3,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 4 ******************************************/
uint16_t  pal4[16];
setpal(pal4,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 5 ******************************************/
uint16_t  pal5[16];
setpal(pal5,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 6 ******************************************/
uint16_t  pal6[16];
setpal(pal6,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 7 ******************************************/
uint16_t  pal7[16];
setpal(pal7,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 8 ******************************************/
uint16_t  pal8[16];
setpal(pal8,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 9 ******************************************/
uint16_t  pal9[16];
setpal(pal9,0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff);
...
/****************************************** screen 10 ******************************************/
uint16_t  pal10[16];
setpal(pal10,0x0,0x4563,0xc111,0x2545,0x6995,0x1442,0xf875,0xd212,0xc333,0x221,0x4231,0x9414,0x5673,0x6442,0x8884,0x0);
...
/****************************************** screen 11 ******************************************/
uint16_t  pal11[16];
setpal(pal11,0x0,0xe501,0xdea3,0xc211,0x4b12,0xd911,0x3c72,0x2701,0xdb52,0x841,0xa401,0x6521,0xb533,0xd831,0x3a51,0xb100);
...
/****************************************** screen 12 ******************************************/
uint16_t  pal12[16];
setpal(pal12,0x0,0xa113,0xfd6,0x9752,0xdc75,0x432,0xb414,0x556,0x4734,0xa878,0xcda4,0xc111,0x9a72,0x8334,0x1000,0x8dc9);
...
/****************************************** screen 13 ******************************************/
uint16_t  pal13[16];
setpal(pal13,0x0,0x6334,0xb99a,0x2223,0xc887,0x6555,0xfc32,0x778,0x5456,0x1112,0x7425,0x7521,0x6001,0x978b,0x4235,0x1000);
...
/****************************************** screen 14 ******************************************/
uint16_t  pal14[16];
setpal(pal14,0x0,0xa347,0x2b72,0x6014,0xc666,0x2001,0x2852,0xb334,0xe137,0x5332,0x5012,0x8642,0x6ea3,0x3124,0xe359,0xb211);
...
/****************************************** screen 15 ******************************************/
uint16_t  pal15[16];
setpal(pal15,0x0,0x3200,0x6731,0x9fb4,0xc911,0x2300,0xa701,0x1d82,0x6a62,0xac12,0x3520,0xb500,0x9a51,0x2854,0xd432,0xb100);
...
/****************************************** screen 16 ******************************************/
uint16_t  pal16[16];
setpal(pal16,0x0,0xc751,0x6223,0xfe75,0x3d91,0x6001,0x4111,0x321,0x9555,0x112,0xca71,0xcb26,0x6ec4,0xe531,0x7000,0xfdb6);
...
/****************************************** screen 17 ******************************************/
uint16_t  pal17[16];
setpal(pal17,0x0,0x5783,0x1110,0x8552,0xe663,0xe221,0x4444,0x6331,0xe988,0xcaa5,0x8984,0x5542,0x9431,0xa624,0x1863,0xf000);
...
/****************************************** screen 18 ******************************************/
uint16_t  pal18[16];
setpal(pal18,0x0,0xd600,0xef42,0xff00,0x5200,0x4c00,0x2323,0xdfd7,0xea51,0xa00,0xa656,0x5400,0xd822,0x800,0x6f73,0xa101);
...
/****************************************** screen 19 ******************************************/
uint16_t  pal19[16];
setpal(pal19,0x0,0xab01,0xe889,0xe667,0x6223,0x1800,0xc424,0x9e11,0x6501,0xf913,0x111,0x6301,0x8756,0xe445,0x7aaa,0xf000);
...
/****************************************** screen 20 ******************************************/
uint16_t  pal20[16];
setpal(pal20,0x0,0xd345,0x3557,0xd89b,0xd456,0xe001,0xa669,0xb223,0xb446,0x6001,0x6214,0x112,0xc547,0xd234,0xb779,0x8000);
...
/****************************************** screen 21 ******************************************/
uint16_t  pal21[16];
setpal(pal21,0x0,0x4431,0x1555,0x1d91,0xd984,0x7a71,0x8321,0x9222,0x6001,0x8111,0xb741,0xf412,0x3fb2,0x8961,0x7ec5,0x0);
...
/****************************************** screen 22 ******************************************/
uint16_t  pal22[16];
setpal(pal22,0x0,0x2335,0xd678,0x6001,0x2113,0x3223,0x3446,0xaaac,0x112,0x445,0x589a,0xc78a,0x1313,0x2923,0x2557,0x0);
...
/****************************************** screen 23 ******************************************/
uint16_t  pal23[16];
setpal(pal23,0x0,0x6e50,0x1ff8,0xa20,0xf80,0x8f70,0x2d20,0xffc0,0xae30,0xefe5,0xec20,0xa910,0xab20,0x2fa0,0x2e40,0xcff2);
...
/****************************************** screen 24 ******************************************/
uint16_t  pal24[16];
setpal(pal24,0x0,0xd90f,0xd205,0x9e0f,0xda0f,0xc60e,0x850b,0xdb0f,0x8408,0x960d,0xde0f,0xd50c,0x980f,0x8307,0xdc0f,0x970e);
...
/****************************************** screen 25 ******************************************/
uint16_t  pal25[16];
setpal(pal25,0x0,0xe553,0x7331,0x6984,0x9764,0xc542,0xa321,0x1773,0x333,0x2853,0x1a97,0xaa86,0x7312,0xc666,0x1110,0x7000);
load_palettes(pal25,PALETTES+PALOFFSET*40);
}

static const NGPaletteAsset ng_screen_palette_assets[] = {
    {1,16,{0x0,0x8654,0xf08d,0x6582,0x7b52,0x7ba7,0xa05b,0x7157,0x68b2,0x6032,0x74ac,0x6345,0x1362,0x2988,0x4122,0xbccc}},
    {2,17,{0x0,0xb05c,0x24bf,0x8fff,0xe26b,0x8049,0xe7df,0x79bd,0x108e,0xcde,0xa04b,0xa19f,0x77ad,0xe2af,0x907d,0xd59c}},
    {3,18,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {4,19,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {5,20,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {6,21,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {7,22,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {8,23,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {9,24,{0x0,0xe112,0x5c00,0x1fc3,0xefb7,0x2941,0x800,0xcf09,0x4038,0xd492,0x8452,0x5d82,0xebbc,0xe411,0x8000,0x7fff}},
    {10,25,{0x0,0x4563,0xc111,0x2545,0x6995,0x1442,0xf875,0xd212,0xc333,0x221,0x4231,0x9414,0x5673,0x6442,0x8884,0x0}},
